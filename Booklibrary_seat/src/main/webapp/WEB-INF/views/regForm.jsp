...
<body>
	...
	<form id="form" action="reg.do" method="post" name="frm">
		...
		<table border="1">
			...
			<tr>
				<td>아이디</td>
				<th><input type="text" id="student_id" name="student_id"
					style="height: 30px; width: 55%; float: left"><input
					type="button" value="중복체크" onclick=" return idcheck()"
					style="float: right; width: 30%;"></th>
			</tr>
			<tr>
				<td>비밀번호</td>
			...
			<tr>
				<td>전화번호</td>
				<th><input type="text" name="student_tel"
					onKeyup="inputPhoneNumber(this);" maxlength="13" /></th>
			</tr>
			<h3>
