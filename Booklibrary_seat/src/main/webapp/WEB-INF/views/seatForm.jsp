...
<body>
	...
	<form action="seatInsert.do" method="get">
		<input type="text" name="id" value="${sessionScope.id }" readonly
			style="border: 1px solid white"><br> <select
			name="seatNo" id="sNo">
		...
		</select> <input type="submit" value="예약" onclick="return c()">
	</form>
		
	<p style="color:red;">*빨간색 좌석은 예약 불가입니다*</p>
	<p>
		<input type="button" value="자리 현황" onclick="seatList()"> <input
			type="button" value="내 자리 확인"
			onclick="location.href='/oneStudent.do?id=${sessionScope.id }'">
	</p>
	<div>${arr }</div>
